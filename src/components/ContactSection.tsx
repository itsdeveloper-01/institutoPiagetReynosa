...
export default function ContactSection({ data }: ContactSectionProps) {
  ...
  return (
    <section id="contacto" className="section-sky py-20 lg:py-28">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          <div className="glass-card rounded-3xl p-10 lg:p-14">
            ...
            <p className="text-slate-600 mb-8 leading-relaxed">{data.body}</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-full px-7 py-3 transition-all duration-200 hover:-translate-y-0.5 shadow-md hover:shadow-lg"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 btn-primary"
              >
