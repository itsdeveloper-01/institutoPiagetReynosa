  ...
  const inner = (
    <div>
      ...
      <div className="flex flex-col gap-2">
        {faq.map((item, i) => (
          <div key={i} className="rounded-xl border border-white/40 bg-white/30 overflow-hidden">
            <button
            ...
            >
              ...
              <span
                ...
                style={{ backgroundColor: open === i ? "#1D4E9E" : "#e2e8f0", transform: open === i ? "rotate(45deg)" : "none" }}
              >
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                  <path d="M5 1v8M1 5h8" stroke={open === i ? "white" : "#64748b"} strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              </span>
            </button>
            {open === i && (
              <div className="px-5 pb-4 text-slate-600 text-sm leading-relaxed border-t border-white/40">
                {item.answer}
              </div>
            )}
          </div>
